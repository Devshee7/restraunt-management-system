 ...
 * @author Devshee
 */
public class OO_Restraunts extends javax.swing.JFrame {

    /**
     * Creates new form OO_Restraunts
     */
    public OO_Restraunts() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 1190, 120));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 390, 440, 150));
        ...
        jLabel8.setText("Chhole Tikkiya");

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel9.setText("Pav Bhaji");

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel10.setText("Chilli Paneer");
        ...
        jLabel14.setText("Chhole Bhature");

        jLabel15.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel15.setText("Masala Dosa");
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 430, 240));

        jPanel5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 12));

        jLabel16.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel16.setText("Masala Tea");

        jLabel17.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel17.setText("Lassi");

        jLabel18.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel18.setText("Coffee");

        jLabel19.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel19.setText("Oreo Milkshake");

        jLabel20.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel20.setText("Butter Milk");
        ...
        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 140, 440, 240));
        ...
        getContentPane().add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 390, 430, 150));
        ...
        getContentPane().add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 140, 300, 480));

        jPanel10.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 12));

        jButtonTotal.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        ...
        jButtonReceipt.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        jButtonReceipt.setText("Receipt");
        jButtonReceipt.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jButtonreset.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        ...
        jButtonExit.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                .addGap(64, 64, 64)
                .addComponent(jButtonTotal, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(106, 106, 106)
                .addComponent(jButtonReceipt, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        getContentPane().add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 550, 880, 70));
    ...
    JTextField cleartext= null;
      for(Component a:jPanel4.getComponents())
      {
          ...
          for(Component b:jPanel5.getComponents())
      {
          ...
          for(Component c:jPanel7.getComponents())
      {
          ...
          for(Component d:jPanel3.getComponents())
      {
...
ItemCost.PavBhaji =ItemCost.pPavBhaji *Double.parseDouble(jTextField9.getText());
ItemCost.ChholeTikkiya =ItemCost.pChholeTikkiya*Double.parseDouble(jTextField7.getText());
ItemCost.MasalaDosa =ItemCost.pMasalaDosa *Double.parseDouble(jTextField8.getText());
ItemCost.ChholeBhature =ItemCost.pChholeBhature *Double.parseDouble(jTextField14.getText());
ItemCost.ChilliPaneer =ItemCost.pChilliPaneer*Double.parseDouble(jTextField13.getText());

ItemCost.Lassi =ItemCost.pLassi *Double.parseDouble(jTextField16.getText());
ItemCost.MasalaTea =ItemCost.pMasalaTea*Double.parseDouble(jTextField17.getText());
ItemCost.ButterMilk =ItemCost.pButterMilk *Double.parseDouble(jTextField19.getText());
ItemCost.Coffee =ItemCost.pCoffee *Double.parseDouble(jTextField15.getText());
ItemCost.OreoMK=ItemCost.pOreoMK*Double.parseDouble(jTextField18.getText());
...
jTextField6.setText(Meal);

String Drink =String.format("£%.2f", ItemCost.Drinks);
jTextField5.setText(Drink);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) throws ClassNotFoundException, IllegalAccessException, UnsupportedLookAndFeelException, InstantiationException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OO_Restraunts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
UIManager.setLookAndFeel("com.jtattoo.plaf.acryl.AcrylLookAndFeel");
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OO_Restraunts().setVisible(true);
            }
